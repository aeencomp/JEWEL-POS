...
const products: Product[] = [
  ...
  },
  {
    id: "oil",
    name: "OilPOS",
    nameAr: "نقطة بيع البترول",
    description: "Fuel station & oil distribution management with real-time inventory and delivery tracking.",
    descriptionAr: "إدارة محطات الوقود وتوزيع الزيت مع تتبع المخزون الفوري والتسليم.",
    icon: Droplets,
    gradient: "from-blue-600 to-cyan-600",
    iconBg: "bg-blue-600",
    available: false,
    tags: ["Fuel", "Distribution", "Deliveries"],
    tagsAr: ["وقود", "توزيع", "توصيل"],
  },
  {
    id: "grocery",
    name: "GroceryPOS",
