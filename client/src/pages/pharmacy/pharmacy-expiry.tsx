...
export default function PharmacyExpiry() {
  ...
  const { data, isLoading } = useQuery<ExpiryResponse>({ queryKey: ["/api/pharmacy/expiry-alerts?days=90"] });
    ...
    <div className="p-6 space-y-4 max-w-6xl mx-auto">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          {isAr ? "أدوية منتهية أو تنتهي خلال 90 يوماً" : "Drugs expired or expiring within 90 days"}
        </p>
      </div>
