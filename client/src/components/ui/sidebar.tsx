  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={cn(
          "fixed inset-y-0 z-10 hidden h-svh w-[var(--sidebar-width)] transition-[left,right,width,inset-inline-start,inset-inline-end] duration-200 ease-linear md:flex",
          side === "left"
